...
<div class="module-screen compact">
    <div class="surface-note">
        LDAP stays external, but people and access are cached locally for fallback mail sign-in and shell sessions.
    </div>
    ...
    @if ($can_manage_directory)
        <div class="table-card">
            <div class="screen-header">
                <div>
                    <h2 class="screen-title">Connector settings</h2>
                    <p class="screen-subtitle">One LDAP connection per organization. The cached local copy remains the session source.</p>
                </div>
                <form method="POST" action="{{ $sync_route }}">
                    @csrf
        ...
        @if ($connection !== null)
            <div class="table-card">
                <div class="screen-header">
                    <div>
                        <h2 class="screen-title">Group mappings</h2>
                        <p class="screen-subtitle">Groups decide inherited roles and scopes. Users without a match stay cached but unassigned.</p>
                    </div>
                </div>
                ...
                <table class="entity-table" style="margin-top:18px;">
                    <thead>
                        <tr>
                            <th>LDAP group</th>
                            <th>Roles</th>
                    ...
                    <tbody>
                        @forelse ($mappings as $mapping)
                            <tr>
                                <td>
                                    <div class="entity-title">{{ $mapping['ldap_group'] }}</div>
                                </td>
    ...
    <div class="table-card">
        <div class="screen-header">
            <div>
                <h2 class="screen-title">Cached directory people</h2>
                <p class="screen-subtitle">The local copy is what powers fallback mail links and scope-limited sessions.</p>
            </div>
        </div>
        <table class="entity-table">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="5" class="muted-note">No LDAP-backed people cached for this organization yet.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
