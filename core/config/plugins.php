...
return [
    ...
    'enabled' => array_values(array_filter(array_map(
        ...
        explode(',', (string) env('PLUGINS_ENABLED', 'hello-world,asset-catalog,actor-directory,controls-catalog,risk-management,findings-remediation,policy-exceptions,data-flows-privacy'))
    ))),
];
