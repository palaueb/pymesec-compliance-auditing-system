...
class CoreTenancySeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('vendor_questionnaire_templates')->insertOrIgnore([
            [
        ...
        DB::table('vendor_questionnaire_template_items')->insertOrIgnore([
            [
        ...
        DB::table('vendor_review_questionnaire_items')->insertOrIgnore([
            [
            ...
            [
                ...
                'review_id' => 'vendor-review-restore-labs-2026',
                'organization_id' => 'org-a',
                'scope_id' => 'scope-it',
